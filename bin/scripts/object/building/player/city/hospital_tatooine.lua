...
object_building_player_city_hospital_tatooine = object_building_player_city_shared_hospital_tatooine:new {
	skillMods = {
		...
		{"private_medicine_assembly", 10},
		{"private_medicine_experimentation", 5},
		{"private_safe_logout", 1}
	},
	lotSize = 3,
	baseMaintenanceRate = 50,
		allowedZones = {"corellia", "dantooine", "lok", "naboo", "rori", "talus", "tatooine", "chandrila", "taanab", "mandalore", "kaas"},
	length = 5,
	width = 5,
